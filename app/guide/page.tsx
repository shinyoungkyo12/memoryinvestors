...
const TERMS: { group: string; items: Term[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        term: "해외 야간시세",
        desc: "한국 장 마감 후, 독일 프랑크푸르트 거래소에 상장된 삼성·하이닉스 GDR의 시세. 흔히 '독일 하이닉스/독일장'이라 부르며, 다음 날 갭의 선행지표로 참고합니다.",
      },
      {
        term: "GDR",
        en: "Global Depositary Receipt",
        desc: "해외 거래소에서 거래되도록 발행한 예탁증서. GDR 1주가 본국 보통주 여러 주를 대표하며, 통화도 현지(유럽은 EUR)로 표시됩니다.",
      },
    ],
  },
];
