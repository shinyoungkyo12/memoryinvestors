...
export const metadata: Metadata = {
  title: "자주 묻는 질문 (FAQ)",
  description:
    "메모리 반도체 현물가는 어디서 보나요? HBM 점유율, 독일 야간시세, 메모리 지수 산출 방식 등 자주 묻는 질문을 정리했습니다.",
...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: "독일 야간시세(독일 하이닉스)가 무엇인가요?",
    a: "한국에는 삼성·하이닉스 개별 종목 야간선물이 없습니다. 대신 독일 프랑크푸르트 거래소에 상장된 GDR이 한국시간 16:00~04:00에 거래되며, 이 가격을 흔히 '독일 하이닉스/독일장'이라 부릅니다. 이 사이트는 실시간 차트에서 삼성·하이닉스 선택 시 '해외야간시세'로 전환해 원화 환산값을 볼 수 있습니다.",
  },
  {
